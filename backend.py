...
trainer.train("./training_data.yml")
...
# Usage example
conversation_context = ("1. The following is a conversation with an Interviewer, who wants to know you. "
                        "2. You are a candidate for a software developer position. "
                        "3. Here's context of your CV, answer the interviewer's questions based on the context.")

# Assuming 'cv_details.txt' contains the text of your CV.
conversation_context = append_text_from_file(conversation_context, 'CV.txt')


# Replace with your actual API key
openai.api_key = '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'
